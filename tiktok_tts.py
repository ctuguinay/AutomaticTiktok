import requests, base64, argparse, os, playsound, re, textwrap
...
def tts_batch(session_id: str, text_speaker: str = 'en_male_funny', req_text: str = 'TikTok Text to Speech', filename: str = 'voice.mp3'):
    req_text = req_text.replace("+", "plus")
    req_text = req_text.replace(" ", "+")
    req_text = req_text.replace("&", "and")
